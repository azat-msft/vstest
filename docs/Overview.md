...
The server supports processing only a single request at a time. Unless the request is [Cancel](#cancellation-support) or [Abort](#cancellation-support) request.
