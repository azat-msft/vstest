...
Previously there was also recorder for `V1`. That was removed with TPv0 removal from VS2026 in [#15247](https://github.com/microsoft/vstest/pull/15247), where VSTest Video recorder was also removed by mistake.
